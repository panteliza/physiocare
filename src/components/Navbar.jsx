...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="w-full bg-[#2E5090] text-white py-4 px-8 flex justify-between items-center shadow-lg fixed top-0 left-0 z-50">
        {/* Logo */}
        ...
        {/* Mobile Sidebar */}
        {showSidebar && (
          <div className="fixed top-0 left-0 w-[300px] h-full bg-[#2E5090] shadow-lg z-50 flex flex-col">
            <MdOutlineClose
